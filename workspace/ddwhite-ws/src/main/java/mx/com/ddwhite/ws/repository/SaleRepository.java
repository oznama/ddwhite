...
public interface SaleRepository extends JpaRepository<Sale, Long> {
	...
	@Query("SELECT s FROM Sale s WHERE s.id=:id AND s.dateCreated BETWEEN :start AND :end")
	List<Sale> findByIdAndRange(@Param("id") Long id, @Param("start") String start, @Param("end") String end, Pageable pageable);
